...
| **Deploy trigger** | push to Gitea `guinness` → **Coolify auto-deploys** (Gitea webhook → `/webhooks/source/gitea`, wired 2026-06-18) | push to Gitea `guinness` → **Coolify auto-builds + serves** |
